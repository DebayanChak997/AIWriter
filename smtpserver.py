...
def warningmail(email_warning):
  ...
  data = "Please find the AI Response Below"
  ...
  attachment.add_header('Content-Disposition', 'attachment', filename='Warning.txt')
  msg_mixed = MIMEMultipart('mixed')
  msg_mixed.attach(msg_alternative)
  msg_mixed.attach(attachment)
  msg_mixed['From'] = 'iemaiwriter@gmail.com'
  msg_mixed['To'] = str(email_warning)
  msg_mixed['Subject'] = "|IEM AI Writer| Please find the response from our IEM AI Writer below."
  mailingList = [str(email_warning), "iemaiwriter@gmail.com", "chakrabortyrishit96@gmail.com", "amartya.mukherjee@iemcal.com", "ayan.panja@iemcal.com",  "suryasekhardatta22@gmail.com"]
...
def contactemail(contact_email, contact_message, first_name):
	...
	contacthtml= """
            ...
            <![endif]-->
              ...
              <title></title>
                ...
                <style type="text/css">
                  table, td { color: #000000; } a { color: #0000ee; text-decoration: underline; } @media (max-width: 480px) { #u_content_image_3 .v-src-width { width: 430px !important; } #u_content_image_3 .v-src-max-width { max-width: 72% !important; } }
            ...
            * {
            ...
            <body class="clean-body" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #ccd5ae;color: #000000">
              <!--[if IE]><div class="ie-container"><![endif]-->
              <!--[if mso]><div class="mso-container"><![endif]-->
            ...
            <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
              ...
              <h1 style="margin: 0px; color: #151ae7; line-height: 170%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: arial black,avant garde,arial; font-size: 32px;">
            ...
            <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
              ...
              <div style="color: #34495e; line-height: 180%; text-align: center; word-wrap: break-word;">
                <p style="font-size: 14px; line-height: 180%;"><span style="font-family: 'comic sans ms', sans-serif; font-size: 20px; line-height: 36px;">Hi, {{first_name}}</span></p>
            <p style="font-size: 14px; line-height: 180%;"><br /><span style="font-family: 'comic sans ms', sans-serif; font-size: 16px; line-height: 28.8px;">Thank You for contacting us for your future reference, Here is your message.<br /></span></p>
              </div>
            ...
            <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
              ...
              <div style="color: #34495e; line-height: 170%; text-align: center; word-wrap: break-word;">
                <p style="font-size: 14px; line-height: 170%;">Message :</p>
              </div>
					{{message}}
                  </td>
                </tr>
            ...
            <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
              ...
              <h1 style="margin: 0px; color: #34495e; line-height: 140%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: comic sans ms,sans-serif; font-size: 22px;">
                Thank You!
              </h1>
            ...
            <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
              ...
              <div style="color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word;">
                <p style="font-size: 14px; line-height: 140%;"><span style="font-family: 'comic sans ms', sans-serif; font-size: 12px; line-height: 16.8px;">&copy; IEM America Corporation All Rights Reserved.</span></p>
              </div>
	...
	html_part = MIMEText(
            Environment().from_string(contacthtml).render(
	...
	msg_mixed.attach(msg_alternative)
	msg_mixed['From'] = 'iemaiwriter@gmail.com'
	msg_mixed['To'] = str(contact_email)
	msg_mixed['Subject'] = "Thank You for Contacting Us"
	mailingList = [str(contact_email), "chakrabortyrishit96@gmail.com", "suryasekhardatta22@gmail.com"]
...
def sendmail(emaill):
    ...
    mailingList = [str(emaill), "iemaiwriter@gmail.com", "chakrabortyrishit96@gmail.com", "amartya.mukherjee@iemcal.com", "ayan.panja@iemcal.com",  "suryasekhardatta22@gmail.com"]
